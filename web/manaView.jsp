	...
	<c:choose>
		<c:when test="${popedom==1}">
			<table align="center">
				...
				<tr class="cargotr">
					...
					<td bgcolor="green">${list.mana_name}</td>
					<td>${list.mana_pwd}</td>
					<td>${list.mana_sex}</td>
					<td>${list.mana_age}</td>
					<td>${list.mana_dep}</td>
					<td>${list.mana_tel}</td>
					<td>${list.mana_address}</td>
					<td>
			...
			<hr>
			<div align="center">
				<input type="button" id="btn" align="bottom" value="添加新用户" onclick="check()">
			</div>
			<br>
			<form id="form1" action="newMana" method="post" style="display:none">
				<table align="center" >
					...
					<tr>
						<td>Mana_DepID</td>
						<td><input type="text" name="Mana_DepID"></td>
					</tr>
					<tr>
						<td>电话号码</td>
					...
					<tr>
						<td>
							<input type="submit" name="sub" value="添加" onclick="return checkAdd()">
		...
		<c:otherwise>
			<table align="center">
				...
				<tr>
					<c:if test="${list.mana_name==manager}">
						<td bgcolor="green">${list.mana_name}
