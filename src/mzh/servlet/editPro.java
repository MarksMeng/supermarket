...
public class editPro extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(id!=null){
			...
			javax.servlet.RequestDispatcher requestDispatcher = request.getRequestDispatcher("/edit.jsp");
		...
		if(typeViewId!=null) {
			...
			javax.servlet.RequestDispatcher requestDispatcher = request.getRequestDispatcher("/editTypeView.jsp");
			requestDispatcher.forward(request, response);
			}
	}
		/**
